...
class LoginScreen extends Component {
	...
	render() {
		return (
			<View style={{ flex: 1 }}>
				<LinearGradient colors={[ '#8e44ad', '#9b59b6', '#34495e' ]} style={styles.container}>
					<View style={styles.formContainer}>
						<View style={styles.userContainer}>
							<View style={styles.iconContainer}>
								<FontAwesome style={{ alignSelf: 'center' }} name="user" size={28} color="#333333" />
							</View>
							<TextInput
								style={styles.user}
						...
						<View style={styles.passwordContainer}>
							<View style={styles.iconContainer}>
								<FontAwesome style={{ alignSelf: 'center' }} name="key" size={28} color="#333333" />
							</View>
							<TextInput
